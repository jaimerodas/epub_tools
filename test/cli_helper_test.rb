...
class CLIHelperTest < Minitest::Test
  ...
  def test_add_verbose_option
    ...
    assert options[:verbose], 'Default verbose should be true'
    ...
    refute options[:verbose], 'Verbose should be false when -q is passed'
  end
  ...
  def test_handle_command_with_invalid_command
    ...
    refute result, 'handle_command should return false for an invalid command'
  end
